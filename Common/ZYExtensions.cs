...
public static class ZYExtensiongs
{
  // #region TransformExt
  /// <summary>
  ...
  public static void CopyTransformFrom(this Transform selfTf, Transform otherTf)
  {
  ...
  //   {
  //     if (tf.GetChild(i))
  //       ZYUtils.Destroy(tf.GetChild(i).gameObject);
  //   }
  // }
  ...
  //   {
  //     ZYUtils.EditorLogWarning("Trying to swap sibling order with transform under a different object!");
  //     return;
  //   }
