...
/// <summary>
/// 全局音频管理器。
/// 负责背景音乐和音效的播放、暂停、停止与音量控制，并支持从 Resources 路径加载音频资源并缓存。
/// 作为 MonoSingleton，会在场景切换时保持存在，适合统一管理游戏中的常用音频播放入口。
/// </summary>
public class ZYAudioManager : ZYMonoSingleton<ZYAudioManager>
{
