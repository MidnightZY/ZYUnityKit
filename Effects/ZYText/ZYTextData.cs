...
{
    public class ZYTextData
    {
        public ZYTextCharData[] charData;

        public void ConstructCharData(TMP_Text text)
        {
            TMP_TextInfo info = text.textInfo;
            int len = info.meshInfo[0].vertexCount / 4;
            charData = new ZYTextCharData[len];
            int count = 0;
            ZYTextCharData data = new ZYTextCharData();
