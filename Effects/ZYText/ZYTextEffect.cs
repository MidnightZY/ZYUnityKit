...
namespace ZYUnityKit
{
    public class ZYTextEffect
    {
        ...
        public ZYTextAnimMode mode = ZYTextAnimMode.OneWay;
        public ZYTextEffectType type = ZYTextEffectType.None;
        public int startIndex = 0, endIndex = int.MaxValue;
        public ZYCurve curve = ZYCurve.LinearIn;
